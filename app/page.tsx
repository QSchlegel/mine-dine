...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      {/* p5 Particle Background - lowest z-index */}
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <motion.p
              variants={staggerItem}
              className="max-w-2xl mx-auto text-lg sm:text-xl text-[var(--foreground-secondary)] leading-relaxed"
            >
              Experience authentic home-cooked meals from passionate chefs. 
              <span className="text-pink-600 dark:text-pink-400 font-medium"> No reservations needed, just real food and real connections.</span>
            </motion.p>
            ...
            >
              ...
              >
                <Button 
                  size="lg" 
                  className="!text-xl sm:!text-2xl !px-10 sm:!px-14 !py-6 sm:!py-8 !h-auto !font-bold !shadow-2xl hover:!shadow-glow-coral relative z-10"
                  href="/dinners"
                >
                  Ready to Dine!
                </Button>
            ...
            >
              <Button variant="outline" size="lg" className="w-full sm:w-auto" href="/dinners">
                Browse Dinners
              </Button>
              <Button variant="outline" size="lg" className="w-full sm:w-auto" href="/host/apply">
                Become a Host
              </Button>
            </motion.div>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-[var(--background-secondary)]">
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-[var(--background-secondary)] relative overflow-hidden">
        ...
        >
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button size="lg" href="/dinners">
              Find a Dinner
            </Button>
            <Button variant="secondary" size="lg" href="/host/apply">
              Apply to Host
            </Button>
          </div>
        </motion.div>
  ...
  return (
    <div className="text-center">
      <div className="flex items-center justify-center gap-2">
        ...
        <div className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-pink-500 to-purple-500 bg-clip-text text-transparent">{value}</div>
      </div>
